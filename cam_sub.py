...
def cam_call(data):
    ...
    base_options = python.BaseOptions(model_asset_path='/home/devg6/catkin_ws/src/dev_pack/scripts/hand_landmarker.task')
...
def main():
    ...
    rospy.Subscriber('dev_web_img', Image, cam_call)
    rate = rospy.Rate(1)
    rate.sleep()
    rospy.spin()
